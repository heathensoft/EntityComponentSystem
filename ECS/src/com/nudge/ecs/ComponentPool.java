 ...
 * ComponentPool
 *
 * Component pools must be registered by the ECS: nudge.ecs.componentManager.addPool(pool);
 * before the ESC is initialized: nudge.ecs.initialize();
 *
 ...
 *
 * It lets the MemoryManager keep track of various component/pool life-cycle statistics (available in nudge.ecs.memoryManager)
